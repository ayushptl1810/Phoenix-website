    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-5xl py-20">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 border border-white/30 rounded-full mb-6 reveal">
            <HiSparkles className="w-4 h-4 text-white" />
            <span className="font-ui text-sm text-white font-bold">
              Partner With Us
            </span>
          </div>
          <h1 className="font-display text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white via-orange-200 to-orange-400 bg-clip-text text-transparent leading-[1.1]">
            {data.title}
          </h1>
          <p className="font-body text-xl md:text-2xl text-gray-300 leading-relaxed">
            {data.subtitle}
          </p>
